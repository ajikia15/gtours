    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 text-gray-500">
        ...
        <p className="text-center max-w-md text-gray-600 leading-relaxed">
          We&apos;re preparing stunning visuals for this tour. Check back soon
          or contact us for a preview!
        </p>
          ...
          >
            ...
            <div
              className={cn(
                ...
                viewMode === "masonry" ? "w-full" : "h-full"
              )}
            >
              <Image
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-gray-600 text-sm">
            Explore the beauty and highlights of {tour.title[0]} through our
