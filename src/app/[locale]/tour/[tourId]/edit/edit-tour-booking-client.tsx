...
export default function EditTourBookingClient({ tour }: EditTourBookingClientProps) {
  ...
  return (
    <div className="container mx-auto py-8 space-y-6 max-w-4xl">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Base price: {tour.basePrice} GEL per person • {tour.duration} days
              </p>
            </div>
          </div>
      ...
      <div className="flex gap-4">
        ...
        >
          {bookingState.isComplete ? "Proceed to Checkout" : "Complete Required Fields"}
        </Button>
      </div>
      ...
      <Card className="p-4 bg-blue-50 border-blue-200">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-medium text-blue-900 mb-2">Booking Confirmation</h3>
            <ul className="text-sm text-blue-800 space-y-1">
              <li>• Review all details before proceeding to checkout</li>
              <li>• Your booking will be confirmed after payment</li>
              <li>• You can modify your booking details until payment is completed</li>
